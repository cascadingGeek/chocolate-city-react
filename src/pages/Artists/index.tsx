                ...
                <div className="flex flex-col gap-3" key={index}>
                  ...
                  <div className="w-full h-auto flex flex-col items-start">
                    <div className="w-auto h-auto flex flex-row items-center gap-2">
                      <p className="text-gray-500 text-xs md:text-sm lg:text-sm xl:text-sm 2xl:text-sm">
                        Alias:{" "}
                      </p>
                    ...
                    <div className="w-auto h-auto flex flex-row items-center gap-2">
                      ...
                      <p className="text-white text-sm md:text-base lg:text-lg xl:text-lg 2xl:text-lg">
                        {data?.name}
                      </p>
                    </div>
                  </div>
